...
void MainWindow::initStyles()
{
    ...
    m_darkStyle =
        ...
        "QPushButton { color: white; background-color: #1e1e2f; }"
        "QMessageBox { color: white; background-color: #1e1e2f; }"
        "QLineEdit { "
        "border-radius: 15px; "
        "padding: 5px 15px; "
    ...
    m_lightStyle =
        ...
        "QLabel { color: #1e1e2f; }"
        "QPushButton { color: #1e1e2f; background-color: white; }"
        "QGroupBox { color: #1e1e2f; font-weight: bold; }"
        "QRadioButton { color: #1e1e2f; }"
        "QToolButton { color: #1e1e2f; }"
        "QMessageBox { color: #1e1e2f; background-color: white; }"
        "QLineEdit { "
        "border-radius: 15px; "
        "padding: 5px 15px; "
